module.exports = {
  name: 'tictactoe',
  aliases: ['ttt'],
  desc: 'Play Tic Tac Toe against someone or yourself',
  ...
  run: async (client, message, args) => {
    ...
    let msg = await message.channel.send(`<@!${Args.user}>'s turn (⭕)`)
    tictactoe(msg);
    async function tictactoe(m) {
      ...
      else if (Args.a2.label == "⭕" && Args.b2.label == "⭕" && Args.c2.label == "⭕") won["⭕"] = true
      else if (Args.a3.label == "⭕" && Args.b3.label == "⭕" && Args.c3.label == "⭕") won["⭕"] = true
      else if (Args.a1.label == "⭕" && Args.b2.label == "⭕" && Args.c3.label == "⭕") won["⭕"] = true
      else if (Args.a3.label == "⭕" && Args.b2.label == "⭕" && Args.c1.label == "⭕") won["⭕"] = true
      else if (Args.a1.label == "⭕" && Args.a2.label == "⭕" && Args.a3.label == "⭕") won["⭕"] = true
      else if (Args.b1.label == "⭕" && Args.b2.label == "⭕" && Args.b3.label == "⭕") won["⭕"] = true
      else if (Args.c1.label == "⭕" && Args.c2.label == "⭕" && Args.c3.label == "⭕") won["⭕"] = true
      ...
      let a = new MessageActionRow().addComponents([a1, a2, a3]), b = new MessageActionRow().addComponents([b1, b2, b3]), c = new MessageActionRow().addComponents([c1, c2, c3])
      let buttons = { components: [a, b, c] }

      m.edit(`<@!${Args.userid}>'s turn (${Args.user == 0 ? "⭕" : "❌"})`, buttons)
